...
\subsection*{Answer} \ \newline
(i) This sentence can be translated as such: if for every $x$, there exists a $y$, for every $z$ the relation $E(x,y)$ holds and $E(y,z)$ holds, then for every $x$ and $z$, there exists $y$ such that the relation $E(x,y)$ holds and $E(y,z)$ holds.
